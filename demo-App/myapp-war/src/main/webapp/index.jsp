...
<BODY>
    ...
    <dsp:droplet name="Switch">
        <dsp:param bean="ProfileFormHandler.profile.transient"
            name="value" />
    ...
    please logout first.
     ...
     each error. --%>
                <dsp:droplet name="Switch">
                    <dsp:param bean="ProfileFormHandler.formError"
                        name="value" />
     ...
     than a guest. --%>
                <dsp:input bean="ProfileFormHandler.value.member"
                    type="hidden" value="true" />
     ...
     produces an error, and does not create the new profile. --%>
                    ...
                    <tr>
                        <td valign=middle align=right>Email
                            Address:</td>
                        <td><dsp:input
                                bean="ProfileFormHandler.value.email"
                    ...
                    <tr>
                        ...
                        <td><dsp:input
                                bean="ProfileFormHandler.value.gender"
                                type="radio" value="male" />Male <dsp:input
                                bean="ProfileFormHandler.value.gender"
     ...
     a new permanent profile using the values in the value Dictionary. --%>
                    <tr>
                        ...
                        <td><dsp:input
                                bean="ProfileFormHandler.create"
