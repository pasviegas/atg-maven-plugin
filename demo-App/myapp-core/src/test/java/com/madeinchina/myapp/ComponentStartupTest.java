...
public class ComponentStartupTest extends TestCase {
	public void testComponentStartup() throws Exception {
		...
		File propFile = NucleusTestUtils.createProperties("test/resources/config/atg/modules/ToBeTested",
		...
		try {
			testComponent = (ToBeTested) n.resolveName("/test/resources/config/atg/modules/ToBeTested");
